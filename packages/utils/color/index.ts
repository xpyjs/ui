import { type Color, type RGBColor, type ColorFormat } from "../../types/color";
...
// 解析颜色字符串
const parseColorString = (color: string): RGBColor | null => {
  // 移除空格
  color = color.trim();
...
// 解析颜色
export const parseColor = (color: Color | null): RGBColor | null => {
